...
//             </div>
//           ) : (
//             // أيقونة ثلاث خطوط ☰ عند إغلاق القائمة
//             <div style={{
//               width: '24px',
//               height: '18px',
//               display: 'flex',
...
//               onToggle={() => {}}
//             >
//               <NavDropdown.Item as={Link} href="/prices/gold" onClick={closeNavbar}>أسعار الذهب</NavDropdown.Item>
//               <NavDropdown.Item as={Link} href="/prices/currency" onClick={closeNavbar}>أسعار الصرف</NavDropdown.Item>
//               <NavDropdown.Item as={Link} href="/prices/poultry" onClick={closeNavbar}>بورصة الدواجن</NavDropdown.Item>
//               <NavDropdown.Item as={Link} href="/prices/materials" onClick={closeNavbar}>أسعار الخامات</NavDropdown.Item>
//               <NavDropdown.Item as={Link} href="/prices/feeds" onClick={closeNavbar}>اسعار الاعلاف</NavDropdown.Item>
//             </NavDropdown>
...
//         {/* زر القائمة المخصص - بدون حدود وحجم صغير */}
//         <button
...
export default function NavigationBar() {
  ...
  return (
    <Navbar 
      bg="light" 
      expand="lg" 
      className="shadow-sm fixed-top px-sm-2  px-md-4 "
      expanded={expanded}
      style={{ zIndex: 1030 }}
    >
